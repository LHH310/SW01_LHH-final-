const boardsStr = localStorage.getItem("boards08");
...
const deleteBtnHandler = () => {
    const boardsObj = JSON.parse(localStorage.getItem("boards08")) || [];
    ...
    if (post) {
        ...
        if (password === post.password) {
            ...
            if (confirmed) {
                ...
                localStorage.setItem("boards08", JSON.stringify(updatedBoards));
                alert("게시물이 삭제되었습니다.");
