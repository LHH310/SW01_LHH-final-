const boardsStr = localStorage.getItem("boards06");
...
const deleteBtnHandler = () => {
    const boardsObj = JSON.parse(localStorage.getItem("boards06")) || [];
    ...
    if (post) {
        ...
        if (password === post.password) {
            ...
            if (confirmed) {
                ...
                localStorage.setItem("boards06", JSON.stringify(updatedBoards));
                alert("게시물이 삭제되었습니다.");
